...
# These are model/data contexts, not an instruction to publish every league.
# Surface-specific release lists remain deliberately narrower until a league
# has completed its shadow validation.
DOMESTIC_LEAGUES = {
