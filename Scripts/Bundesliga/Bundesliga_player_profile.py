"""Bundesliga player profile aggregation -- thin wrapper around EPL core logic."""
...
def parse_args():
    p = argparse.ArgumentParser(description="Aggregate Bundesliga player profiles.")
    p.add_argument(
        "--input",
        default="/Users/sanduandrei/Desktop/Betting_RAG/Output/Bundesliga_feature_engineering/player_engineered_features_2025.json",
    ...
    p.add_argument("--league", default="Bundesliga", help="League code.")
