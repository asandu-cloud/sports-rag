# Champions League feature engineering
...
PLAYER_PATH = Path(f"/Users/sanduandrei/Desktop/Betting_RAG/Output/UCL_output/player_fixture_stats_{SEASON}.json")
FIXTURE_PATH = Path(f"/Users/sanduandrei/Desktop/Betting_RAG/Output/UCL_teams/team_fixture_stats_{SEASON}.json")

OUTPUT_PATH = Path("/Users/sanduandrei/Desktop/Betting_RAG/Output/UCL_feature_engineering")
...
def engineer_player_contextual_features(player_df: pd.DataFrame,
    ...
    # Role tagging for foul/card props. Missing/legacy numeric values are
    # safely treated as an unknown role rather than crashing the refresh.
